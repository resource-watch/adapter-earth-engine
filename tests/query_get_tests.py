...
def test_query_dataset_that_does_not_exist(client, mocker):
    ...
    response = client.get('/api/v1/earthengine/query/foo')
...
def test_query_dataset_invalid_provider(client, mocker):
    ...
    response = client.get('/api/v1/earthengine/query/bar')
...
def test_query_dataset_happy_case(client, mocker):
    ...
    response = client.get('/api/v1/earthengine/query/bar?sql=SELECT%20ST_HISTOGRAM%28rast%2C%20elevation%2C%2010%2C%20true%29%20FROM%20CGIAR%2FSRTM90_V4')
